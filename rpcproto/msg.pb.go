...
var file_msg_proto_rawDesc = []byte{
	0x0a, 0x09, 0x6d, 0x73, 0x67, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x08, 0x72, 0x70, 0x63,
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x1e, 0x0a, 0x08, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x52, 0x65,
...
// GameXClient is the client API for GameX service.
//
...
func NewGameXClient(cc grpc.ClientConnInterface) GameXClient {
	return &gameXClient{cc}
}

func (c *gameXClient) HelloGameX(ctx context.Context, in *HelloReq, opts ...grpc.CallOption) (*HelloRsp, error) {
	out := new(HelloRsp)
	err := c.cc.Invoke(ctx, "/rpcproto.GameX/HelloGameX", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UnimplementedGameXServer struct {
}
...
func RegisterGameXServer(s *grpc.Server, srv GameXServer) {
	s.RegisterService(&_GameX_serviceDesc, srv)
}

func _GameX_HelloGameX_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(HelloReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GameXServer).HelloGameX(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/rpcproto.GameX/HelloGameX",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GameXServer).HelloGameX(ctx, req.(*HelloReq))
	}
